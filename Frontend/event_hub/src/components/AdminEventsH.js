...
class AdminEventsH extends React.Component{
    state = {
      events:[],
      sold : [],
      sales : [],
    ...
    columns_events = [
      ...
      componentDidMount(){
        axios.get('http://127.0.0.1:8000/event/api/Events/get_admin_events_happened/')
        .then(res =>{
          this.setState({
